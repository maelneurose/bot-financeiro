...
// === FUNÇÕES ===
// (Mantidas iguais para economizar espaço visual, o importante é o final)
...
// 👇 MÁGICA DO QR CODE MANUAL 👇
client.on('qr', (qr) => {
    // Ainda mostra no terminal, caso funcione
    qrcode.generate(qr, { small: true });
    
    // Gera um link CLICÁVEL que abre o QR Code perfeito no navegador
    const qrLink = `https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=${encodeURIComponent(qr)}`;
    
    console.log('\n================================================================');
    console.log('🚨 SE O QR ABAIXO NÃO LEU, CLIQUE NESTE LINK:');
    console.log(qrLink);
    console.log('================================================================\n');
});
...
client.on('message_create', async (msg) => {
    ...
    if (msg.fromMe) { if (msg.body.startsWith('📝') || msg.body.startsWith('📊') || msg.body.startsWith('🤖') || msg.body.startsWith('✅') || msg.body.startsWith('🔒') || msg.body.startsWith('⚠️')) return; }
